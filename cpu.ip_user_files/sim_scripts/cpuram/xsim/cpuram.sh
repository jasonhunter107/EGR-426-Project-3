...
#
# Generated by Vivado on Mon Apr 16 01:54:08 -0400 2018
...
# Script info
echo -e "cpuram.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot cpuram xil_defaultlib.cpuram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim cpuram -key {Behavioral:sim_1:Functional:cpuram} -tclbatch cmd.tcl -log simulate.log
}
